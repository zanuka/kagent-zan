...
func (in *ModelConfigSpec) DeepCopyInto(out *ModelConfigSpec) {
	*out = *in
	if in.ProviderOpenAI != nil {
		in, out := &in.ProviderOpenAI, &out.ProviderOpenAI
		*out = new(OpenAIConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.ProviderAnthropic != nil {
		in, out := &in.ProviderAnthropic, &out.ProviderAnthropic
		*out = new(AnthropicConfig)
		**out = **in
	}
	if in.ProviderAzureOpenAI != nil {
		in, out := &in.ProviderAzureOpenAI, &out.ProviderAzureOpenAI
		*out = new(AzureOpenAIConfig)
		(*in).DeepCopyInto(*out)
	}
}
